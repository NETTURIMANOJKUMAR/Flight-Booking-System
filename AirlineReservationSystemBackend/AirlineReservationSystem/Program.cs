...
builder.Services.AddDbContext<HawksAvaitionDBContext>(options =>
{
    options.UseSqlServer(
        connectionString: "server=LAPTOP-HL4NRCNV\\SQLEXPRESS;database=HawksAviationDb;Trusted_Connection=True" //builder.Configuration["ConnectionString:HawksAviationDB"]
    ); 
});
#endregion
